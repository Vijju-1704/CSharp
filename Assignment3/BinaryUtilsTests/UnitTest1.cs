...
namespace BinaryUtilsTests
{
    public class BinaryUtilsTests
    {
        ...
        public void BinaryToFloat_Converts(string binary, double expected)
        {
        ...
        public void FloatToBinary_Converts(double value, string expectedStart)
        {
        ...
        [InlineData("0", "0", "0")]
        public void AddBinary_AddsCorrectly(string a, string b, string expectedSum)
        {
        ...
        public void ValidateFloatInput_Works(string input, bool expectedIsValid)
        {
            bool isValid = FloatBinaryCalculator.IsValidFloatInput(input, out double _);
